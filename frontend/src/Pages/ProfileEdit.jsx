...
import { register, updateUserProfile } from '../redux/Slice/UserSlice'
...
export default function ProfileEdit() {
  ...
  const{userInfo,userDetails,loading,error}=user
  console.log(user);
...
useEffect(() => {
 ...
 const submitHandler = (e) => {
  ...
  dispatch(updateUserProfile({name,email,password,phone}))
  navigate('/profile')
